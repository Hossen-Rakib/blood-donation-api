-- ============================================================
-- Blood Donation Platform — PostgreSQL Complete Database Script
...
CREATE TABLE IF NOT EXISTS users (
  ...
  role          VARCHAR(30)  NOT NULL DEFAULT 'requester', -- requester | donor | admin
...
CREATE TABLE IF NOT EXISTS donors (
  ...
  name               VARCHAR(150) NOT NULL,
  email              VARCHAR(255)          DEFAULT NULL, -- Email acts as User ID
  blood_group        VARCHAR(10)  NOT NULL, -- A+, A-, B+, B-, AB+, AB-, O+, O-
  phone              VARCHAR(30)  NOT NULL, -- Mobile phone number for direct contact
  location           VARCHAR(150) NOT NULL, -- Dhaka Area (Mirpur, Dhanmondi, Gulshan, Uttara, Mohammadpur)
  age                INTEGER               DEFAULT NULL,
  gender             VARCHAR(10)           DEFAULT 'Male',
  availability       BOOLEAN      NOT NULL DEFAULT TRUE, -- TRUE = Available, FALSE = Not Available
  verified           BOOLEAN      NOT NULL DEFAULT TRUE, -- Verified donor badge
...
CREATE TABLE IF NOT EXISTS blood_requests (
  ...
  required_date     VARCHAR(50)  NOT NULL, -- 'Immediately' or date string
  contact_number    VARCHAR(30)  NOT NULL,
  urgency           VARCHAR(30)  NOT NULL DEFAULT 'normal', -- normal | emergency
  additional_info   TEXT                  DEFAULT NULL,
  status            VARCHAR(30)  NOT NULL DEFAULT 'pending',
  -- Status Flow: pending -> donor_found -> donor_accepted -> donation_completed -> request_closed
...
CREATE TABLE IF NOT EXISTS donation_history (
  ...
  blood_group       VARCHAR(10)  NOT NULL,
  bags              INTEGER      NOT NULL DEFAULT 1, -- Number of bags donated
  hospital_location VARCHAR(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  type       VARCHAR(50) NOT NULL, -- new_request | request_accepted | request_completed | admin_alert
...
CREATE TABLE IF NOT EXISTS reports (
  ...
  request_id       INTEGER REFERENCES blood_requests(id) ON DELETE SET NULL,
  reason           VARCHAR(100) NOT NULL, -- fake_request | spam | harassment | wrong_information
  description      TEXT                  DEFAULT NULL,
  status           VARCHAR(30)  NOT NULL DEFAULT 'pending', -- pending | reviewed | dismissed
  created_at       TIMESTAMP    NOT NULL DEFAULT NOW()
);
...
-- 2. 40 Donors (5 Donors per blood group in Dhaka: Mirpur, Dhanmondi, Gulshan, Uttara, Mohammadpur)
...
-- 3. Donation History (showing date and number of bags)
